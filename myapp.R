...
"
  ...
  output$Boardplot<-renderPlot({
    ...
    finalBoardmanplot<-ggplot()+
      geom_linerange(data=BoardmanPlot,aes(x=dam,ymin = L50/1000000, ymax = H50/1000000),size=2)+
      geom_linerange(data=BoardmanPlot,aes(x=dam,ymin = L95/1000000, ymax = H95/1000000),size=1)+
  ...
  output$SavagePlot<-renderPlot({
    ...
    finalSRplot<-ggplot()+
      geom_linerange(data=SRPlot,aes(x=dam,ymin = L50/1000000, ymax = H50/1000000),size=2)+
      geom_linerange(data=SRPlot,aes(x=dam,ymin = L95/1000000, ymax = H95/1000000),size=1)+
